        ...
        <div className="form-section flex flex-col items-center lg:flex-row gap-10 lg:gap-10 w-full">
          ...
          >
            {contactItems.map(({ id, label, icon, text, link }) => (
              <div
                className="contact-item flex flex-col gap-2 lg:gap-4"
                key={id}
              >
                ...
                <div className="details flex justify-between items-center">
                  ...
                  >
                    <img
                      src="/images/socialMedia/svg/RightArrow.svg"
                      alt="arrow"
                    />
                  </a>
                </div>
          ...
          >
            <div className="form-items flex flex-col gap-7 md:gap-10 lg:gap-12 w-full">
              <div className="items flex flex-col md:flex-row items-center gap-6 md:gap-12 w-full">
                <div
                  className={`item flex flex-col gap-2 w-full ${
                    formState.name.focused || formState.name.value
                      ? "active"
                      : ""
                  }`}
                >
                ...
                <div
                  className={`item flex flex-col gap-2 w-full ${
                    formState.email.focused || formState.email.value
                      ? "active"
                      : ""
                  }`}
                >
              ...
              <div className="items flex flex-col md:flex-row items-center gap-6 md:gap-12 w-full">
                <div
                  className={`item flex flex-col gap-2 w-full ${
                    formState.phone.focused || formState.phone.value
                      ? "active"
                      : ""
                  }`}
                >
                ...
                <div
                  className={`item flex flex-col gap-2 w-full ${
                    formState.company.focused || formState.company.value
                      ? "active"
                      : ""
                  }`}
                >
              ...
              <div className="items flex items-center md:gap-12 w-full">
                <div
                  className={`item flex flex-col gap-2 w-full ${
                    formState.message.focused || formState.message.value
                      ? "active"
                      : ""
                  }`}
                >
            ...
            <div className="submit-button">
              <button
                className={`flex items-center gap-2 ${
                  buttonState === "submitted" ? "active" : ""
                }`}
                onClick={handleSubmit}
              >
                <p className="btn-text">
                  {buttonState === "submitted" ? "Thanks" : "Send your Inquiry"}
                </p>
